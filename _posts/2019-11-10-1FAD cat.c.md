...
implemented.
## Functions
Since C is following an imperative programming paradigm I will try to describe
each function separately starting with main. For describing it I will make use
of a flowchart and afterwards focus textual on important positions in the code.
